...
class dataedit_library extends dataform_library
{
	...
	protected function sniff_status()
	{
		...
		///// show /////
		if (rpd_url_helper::value('show' . $this->cid))
		{
			$this->set_status("show");
			$this->process_url = "";
			if (!$this->model->load(rpd_url_helper::value('show' . $this->cid)))
			{
				$this->set_status("unknow_record");
			}
			///// modify /////
		} elseif (rpd_url_helper::value('modify' . $this->cid))
		{
			$this->set_status("modify");
			$this->process_url = rpd_url_helper::replace('modify' . $this->cid, 'update' . $this->cid);
			if (!$this->model->load(rpd_url_helper::value('modify' . $this->cid)))
			{
				$this->set_status("unknow_record");
			}
			///// create /////
		} elseif (rpd_url_helper::value('create' . $this->cid))
		{
			$this->set_status("create");
			$this->process_url = rpd_url_helper::replace('create' . $this->cid, 'insert' . $this->cid);
			///// delete /////
		} elseif (rpd_url_helper::value('delete' . $this->cid))
		{
			$this->set_status("delete");
			$this->process_url = rpd_url_helper::replace('delete' . $this->cid, 'do_delete' . $this->cid);
			$this->undo_url = rpd_url_helper::replace('delete' . $this->cid, 'show' . $this->cid);
			if (!$this->model->load(rpd_url_helper::value('delete' . $this->cid)))
			{
				$this->set_status("unknow_record");
			}
		} elseif (rpd_url_helper::value('inset' . $this->cid . '|update' . $this->cid . '|do_delete' . $this->cid))
		{
	...
	{
		///// insert /////
		if (rpd_url_helper::value('insert' . $this->cid))
		{
			$this->set_action("insert");
			$this->postprocess_url = rpd_url_helper::replace('insert' . $this->cid, 'show' . $this->cid);
			///// update /////
		} elseif (rpd_url_helper::value('update' . $this->cid))
		{
			$this->set_action("update");
			$this->postprocess_url = rpd_url_helper::remove('update' . $this->cid);
			if (!$this->model->load(rpd_url_helper::value('update' . $this->cid)))
			{
				$this->set_status("unknow_record");
			}
			///// delete /////
		} elseif (rpd_url_helper::value("do_delete" . $this->cid))
		{
			$this->set_action("delete");
			if (!$this->model->load(rpd_url_helper::value("do_delete" . $this->cid)))
			{
				$this->set_status("unknow_record");
			}
		}
