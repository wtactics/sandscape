...
/**
 * Generic component that represents complex HTML elements.
 */
abstract class Component {
    ...
    public function __construct($view) {
        if (!$view) {
            throw new Exception('Every component needs a view.');
        }
        $this->view = $view;
    }

    /**
     * Returns the view in which this component is being shown.
     * 
     * @return View
     */
