<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('emailVisibility')); ?>:</b>
	<?php echo CHtml::encode($data->emailVisibility); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('acceptMessages')); ?>:</b>
	<?php echo CHtml::encode($data->acceptMessages); ?>
	<br />
